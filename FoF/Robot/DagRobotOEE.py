...
default_args = {
    ...
    "start_date": datetime.datetime.now().replace(minute=4, second=20, microsecond=0) + datetime.timedelta(hours=-2),
    # 开始时间
...
t1Failed = EmailOperator(
    ...
    task_id="Run_RobotOEE_Failed",
    to=["yuan_li5928@jabil.com", "zhuang_hu@jabil.com", "yujie_wu@jabil.com", "huiwen_xu@jabil.com"],
    subject="Run RobotOEE Failed",
    html_content='<h3>Run RobotOEE Failed, Please Check!</h3>')
